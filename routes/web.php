...
if(config('app.env') === 'production') {
    Route::GET('/', ['https', Controllers\User\UserMainPageController::class, 'createProducts'])
        ->name('main');

    Route::GET('/userAgreement', ['https', Controllers\User\UserAgreementController::class, 'create'])
        ->name('userAgreement');

    Route::GET('/dashboard', ['https', Controllers\User\UserProfileController::class, 'create'])
        ->middleware(['auth'])->name('dashboard');

    Route::POST('/dashboard/update', ['https', Controllers\User\UserProfileController::class, 'update'])
        ->middleware(['auth'])->name('updateProfileUser');

    Route::POST('/dashboard/delete', ['https', Controllers\User\UserProfileController::class, 'delete'])
...
//    ->middleware(['auth'])->name('deleteProfileUser');
    ...
    Route::POST('/product/addProductInCart/{product}', ['https', Controllers\User\UserProductController::class, 'addProductInCart'])
        ->name('addProductInCart');

    Route::POST('/product/deleteProductInCartAjax', ['https', Controllers\User\UserProductController::class, 'deleteProductInCartAjax'])
        ->name('deleteProductInCartAjax');

    Route::POST('/product/addProductFromConstructor', ['https', Controllers\User\UserProductController::class, 'addProductFromConstructor'])
        ->name('addProductFromConstructor');

    Route::GET('/catalog', ['https', Controllers\User\UserCatalogController::class, 'create'])
        ->name('catalog');

    Route::GET('/cart', ['https', Controllers\User\UserCartController::class, 'create'])
        ->name('cart');

    Route::POST('/cart/intervals', ['https', Controllers\User\UserCartController::class, 'createIntervalsAjax'])
        ->name('cartIntervals');

    Route::POST('/cart/addOrderToUser', ['https', Controllers\User\UserCartController::class, 'addOrderToUser'])
        ->name('addOrderToUser');

    Route::GET('/order/{order}', ['https', Controllers\User\UserOrderPageController::class, 'create'])
        ->middleware(['auth'])->name('order');

    Route::GET('admin/orders', ['https', Controllers\Admin\AdminOrdersPageController::class, 'create'])
        ->middleware(['auth'])->name('adminOrders');

    Route::POST('admin/orders/createAjax', ['https', Controllers\Admin\AdminOrdersPageController::class, 'createAjax'])
        ->middleware(['auth'])->name('createAjax');

    Route::POST('admin/orders/changeStatusAjax', ['https', Controllers\Admin\AdminOrdersPageController::class, 'changeStatusAjax'])
        ->middleware(['auth'])->name('changeStatusAjax');

    Route::GET('admin/products', ['https', Controllers\Admin\AdminProductsPageController::class, 'create'])
        ->middleware(['auth'])->name('adminProducts');

    Route::POST('admin/products/changeActiveAjax', ['https', Controllers\Admin\AdminProductsPageController::class, 'changeActiveAjax'])
        ->middleware(['auth'])->name('changeActiveAjax');

    Route::GET('admin/products/add', ['https', Controllers\Admin\AdminCreateProductPageController::class, 'create'])
        ->middleware(['auth'])->name('adminProductsAdd');


    Route::POST('admin/products/add/addProduct', ['https', Controllers\Admin\AdminCreateProductPageController::class, 'addProduct'])
        ->middleware(['auth'])->name('adminProductsAddProduct');

    Route::POST('admin/products/add/addProductType', ['https', Controllers\Admin\AdminCreateProductPageController::class, 'addProductType'])
        ->middleware(['auth'])->name('adminProductsAddProductType');

    Route::POST('admin/products/add/addComponent', ['https', Controllers\Admin\AdminCreateProductPageController::class, 'addComponent'])
        ->middleware(['auth'])->name('adminProductsAddComponent');

    Route::POST('admin/products/add/addComponentType', ['https', Controllers\Admin\AdminCreateProductPageController::class, 'addComponentType'])
        ->middleware(['auth'])->name('adminProductsAddComponentType');

    Route::POST('admin/products/add/addIngredient', ['https', Controllers\Admin\AdminCreateProductPageController::class, 'addIngredient'])
        ->middleware(['auth'])->name('adminProductsAddIngredient');

    Route::GET('admin/products/update/{product}', ['https', Controllers\Admin\AdminUpdateProductPageController::class, 'create'])
